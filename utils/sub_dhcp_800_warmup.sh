#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/dhcp_800_warmup_%j.out
...
python /scratch/users/k21113539/SR-UNet/train_vae_nocai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/config_vae_dhcp_t1_800_warmup.py
