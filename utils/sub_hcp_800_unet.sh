#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/hcp_800_unet_%j.out
...
python /scratch/users/k21113539/SR-UNet/train_vae_nocai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/config_unet_hcp_t1_800.py
