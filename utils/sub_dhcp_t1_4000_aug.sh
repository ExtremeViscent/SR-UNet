#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/dhcp_t1_4000_aug_%j.out
...
python /scratch/users/k21113539/SR-UNet/train_vae_nocai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/config_vae_dhcp_t1_4000_aug.py
...
# srun -p gpu -N 2 --gres=gpu:4 --ntasks-per-node=4 python /scratch/users/k21113539/SR-UNet/train_vae_bottleneck.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/config_vae_dhcp_t1.py