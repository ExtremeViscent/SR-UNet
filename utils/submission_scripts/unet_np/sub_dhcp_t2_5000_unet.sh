#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/dhcp_t2_5000_noaug_unet_np_%j.out
...
python /scratch/users/k21113539/SR-UNet/train_cai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/unet_np/config_unet_dhcp_t2_5000.py
