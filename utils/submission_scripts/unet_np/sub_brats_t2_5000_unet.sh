#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/brats_t2_5000_noaug_unet_np_%j.out
#SBATCH --job-name=unet-brats
#SBATCH --gres=gpu:2
...
python /scratch/users/k21113539/SR-UNet/train_cai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/unet_np/config_unet_brats_t2_5000.py
