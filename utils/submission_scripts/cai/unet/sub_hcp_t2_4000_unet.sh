#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/hcp_t2_4000_noaug_unet_%j.out
#SBATCH --job-name=unet-hcp-cai
#SBATCH --gres=gpu:2
...
torchrun --nnodes $NNODES --master_addr $MASTER_ADDR --master_port $MASTER_PORT --node_rank $NODE_RANK --nproc_per_node $NPROC_PER_NODE /scratch/users/k21113539/SR-UNet/train_cai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/cai/config_unet_hcp_t2_4000.py
