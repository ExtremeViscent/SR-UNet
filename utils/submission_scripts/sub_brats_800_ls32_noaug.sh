#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/brats_800_ls32_noaug_%j.out
...
python /scratch/users/k21113539/SR-UNet/train_vae_nocai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/config_vae_brats_t1_ls32_noaug.py
