#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/hcp_t1_4000_noaug_%j.out
...
python /scratch/users/k21113539/SR-UNet/train_vae_nocai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/config_vae_hcp_t1_4000.py
