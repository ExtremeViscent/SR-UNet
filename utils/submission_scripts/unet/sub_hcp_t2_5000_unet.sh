#!/bin/bash
#SBATCH --output=/scratch/users/%u/SR-UNet/logs/hcp_t2_5000_noaug_unet_%j.out
...
python /scratch/users/k21113539/SR-UNet/train_cai.py --config /scratch/users/k21113539/SR-UNet/configs/CREATE/unet/config_unet_hcp_t2_5000.py
